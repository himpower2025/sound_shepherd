...
const SONGS: Song[] = [
  { id: '1', title: 'Soul Piano (Worship Link)', url: 'https://cdn.pixabay.com/audio/2022/02/22/audio_d1be8e046a.mp3' },
  { id: '2', title: 'Acoustic Guitar (Warm)', url: 'https://cdn.pixabay.com/audio/2022/01/18/audio_d0a13f694b.mp3' },
  { id: '3', title: 'Life of a Dream (Sample)', url: 'https://upload.wikimedia.org/wikipedia/commons/e/e1/MLK_-_I_Have_A_Dream_Excerpt.mp3' }
];
